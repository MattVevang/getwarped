...
exports.serviceThemeSchema = exports.serviceConfigurationSchema = exports.ServiceConfigurationValidator = exports.validateServiceTheme = exports.validateServiceConfiguration = void 0;
exports.validateServiceConfigurationWithResult = validateServiceConfigurationWithResult;
exports.validateServiceThemeWithResult = validateServiceThemeWithResult;
exports.validateServiceConfigurationSecurity = validateServiceConfigurationSecurity;
exports.validateServiceConfigurationComplete = validateServiceConfigurationComplete;
...
exports.serviceThemeSchema = serviceThemeSchema;
/**
...
function validateServiceConfigurationWithResult(data) {
    ...
    const errors = exports.validateServiceConfiguration.errors?.map(err => ({
 ...
 * @returns Structured validation result with errors if invalid
 */
function validateServiceThemeWithResult(data) {
    const valid = (0, exports.validateServiceTheme)(data);
    if (valid) {
        return {
            valid: true,
            data: data,
    ...
    const errors = exports.validateServiceTheme.errors?.map(err => ({
        path: err.instancePath || err.schemaPath,
        message: err.message || 'Unknown validation error',
        value: err.data,
        keyword: err.keyword,
 ...
 */
function preprocessServiceConfiguration(data) {
 ...
 */
function validateServiceConfigurationSecurity(config) {
    const issues = [];
    // URL security checks
    try {
 ...
 */
function validateServiceConfigurationComplete(data) {
...
exports.ServiceConfigurationValidator = ServiceConfigurationValidator;
//# sourceMappingURL=ServiceConfigurationSchema.js.map